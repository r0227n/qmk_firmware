...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_QWERTY] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        EQL,     Q,     W,     E,     R,     T,                      Y,     U,     I,     O,     P,  BSPC,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       MINS,     A,     S,     D,     F,     G,                      H,     J,     K,     L,  SCLN,  QUOT,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
        RST,   SSK, LWORD,    UP, RWORD, XXXXX,                  XXXXX,  PGUP,  PGDN,  HOME,   END,   DEL,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____,  LCTL,  LEFT,  DOWN, RIGHT, XXXXX,                  XXXXX, XXXXX,  LBRC,  RBRC,  BSLS, _____,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
                                   LALT, LOWER,  BSPC,      ENT, RAISE,  RCTL\
                              //`--------------------'  `--------------------'
  ),
  ...
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, XXXXX,  LTAB,  LAPP,  RTAB, GUIEI,                  XXXXX, ALTKN, GUIEI, XXXXX, XXXXX, _____,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
      _____, XXXXX,  LDSK,  LFOL,  RDSK, ALTKN,                  XXXXX, XXXXX,  LBRC,  RBRC,  BSLS, _____,\
  //|------+------+------+------+------+------+------|  |------+------+------+------+------+------+------|
